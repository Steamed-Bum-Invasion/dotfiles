-- refer to https://github.com/onosendi/dotfiles/blob/master/.config/nvim/init.lua and
-- https://github.com/paulsonkoly/neovim_config/tree/master
...
-- set linting/formatting, and autocompletion
